...
//I create a 8x8 array with tds (Tetragona)
var chessboard=[];
for (var i=0; i<8; i++){
    var line=[];
	for (var j=0;j<8; j++)
...
//I gave pieces color and name(pown) attribute
for (var i=0;i<32;i++){
    if (i>7 && i<24)
        piece[i].pown="Pawn";
...
function move(x1,y1,x2,y2){
    console.log("Mpika stin move me ",x1,y1,x2,y2);
    ...
    if (!pos2b.hasChildNodes()){
        pos2b.appendChild(pos1b.firstChild);
        do_after_valid_move();
    }
        ...
        pos2b.appendChild(pos1b.firstChild);
        pos2b.removeChild(pos2b.firstChild);
        do_after_valid_move();
    }
}
